...
#define __ESPUINO_SETTINGS_H__
    ...
    */
    ...
    //############# Port-expander-configuration ######################
        ...
        const uint8_t portsToRead = 2;      // PCA9555 has two ports � 8 channels. If 8 channels are sufficient, set to 1 and only use the first port!
    ...
    */
    ...
    #define BUTTON_MULTI_02   TOGGLE_BLUETOOTH_MODE
