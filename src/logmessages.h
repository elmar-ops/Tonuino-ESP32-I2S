...
static const char initialModefromNvs[] PROGMEM = "Initialer Modus wurde aus NVS geladen";
static const char wroteInitialModeToNvs[] PROGMEM = "Initiale Modus wurde ins NVS geschrieben.";
